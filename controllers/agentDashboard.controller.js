...
//        }
        ...
        res.render('agentDashboard/dashboard', { title: "Krypton - S'enrégistrer",   errorMessage: 'Erreur serveur, merci de réessayer'});

      }

async function parametresGet(req, res) {
        const userData = req.user
        const user = userData.user
          res.render('userDashboard/parametres', { title: "Krypton - Mon compte", user});
      }
